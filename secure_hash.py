...
# the hashing functions need a byte array, not strings, hence use ENCODE
for b in python_program.encode('utf8'):
    print(b, chr(b))

original_hash = hashlib.sha256(python_program.encode('utf8'))
print(f"SHA256: {original_hash.hexdigest()}")  # hexdigest turns the hash into a hexadecimal
